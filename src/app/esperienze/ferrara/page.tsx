  ...
  return (
    <main style={{ minHeight: "100vh", background: "#050505", color: "white" }}>
      ...
      <div style={{ position: "fixed", top: 120, right: "6vw", zIndex: 100, display: "flex", gap: 10 }}>
        <Link href="/esperienze/ferrara" className="pill-btn active" style={{ fontSize: 11, padding: "8px 20px" }}>
          Ferrara
        </Link>
        <Link href="/esperienze/bologna" className="pill-btn" style={{ fontSize: 11, padding: "8px 20px" }}>
          Bologna
        </Link>
      </div>
          ...
          <div key={exp.title} className="exp-list-item">
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ marginTop: 26, display: "flex", gap: 12, flexWrap: "wrap" }}>
                <Link href={`/esperienze/ferrara/${encodeURIComponent(exp.title.toLowerCase().replace(/ /g, '-'))}`} className="btn-partner-gold" style={{ padding: "12px 26px", fontSize: "0.9rem", borderRadius: "100px", display: "inline-block" }}>
                  SCOPRI L'ESPERIENZA
                </Link>
              </div>
            </div>
